...
/*bgImg*/
const bgImg= "https://raw.githubusercontent.com/pkkeiki/beybot/gh-pages/playing-norm_giftab-UPDATED.png";
...
const generateTitle = {
  ...
  halloween: " says Happy Halloween!",
  tableflip: " FLIPPED your <br>favorite table!",
...
const resizeText = ({ element, elements, minSize = 1, maxSize = 5, step = 1, unit = 'px' }) => {
